...
var favourite_Pizzas = ['Napoletana', 'alla Pala', 'Tonda Romana', 'al Taglio', 'pizza Fritta', 'padellino', 'siciliana'];
console.log("My Favourite Pizzas");
var ind = favourite_Pizzas.length;
for (ind = 4; ind < favourite_Pizzas.length; ind++) {
    console.log(" ".concat(favourite_Pizzas[ind]));
}
for (ind = 0; ind <= favourite_Pizzas.length; ind++) {
    console.log(" I like ".concat(favourite_Pizzas[ind]));
}
