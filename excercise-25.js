...
var alien_colorArray = ['green', 'yellow', 'red'];
//output version 1
var alien_color = 'green';
console.log("\n\t version 1\t\n \nAlien Color is ".concat(alien_color, " : player just earned 5 points."));
//output version 2
alien_color = 'yellow';
if (alien_color == 'green') {
    console.log("Alien Color is ".concat(alien_color, " : player just earned 5 points."));
}
else {
    console.log("\n\tversion 2\t\n \nAlien Color is ".concat(alien_color, " : player just earned 10 points."));
}
