...
console.log("\n\t version 1\t\n \nAlien Color is ".concat(alien_color, " : player just earned 5 points for shooting the alien"));
//output version 2
alien_color = 'yellow';
if (alien_color == 'green') {
    ...
    console.log("\n\tversion 2\t\n \nAlien Color is ".concat(alien_color, " : player just earned 10 points for shooting the alien"));
}
